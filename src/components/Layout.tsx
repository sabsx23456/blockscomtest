        ...
        <div className="min-h-screen flex flex-col bg-black text-casino-slate-200">
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <aside className={clsx(
                    "fixed inset-y-0 left-0 z-50 w-64 bg-casino-dark-900 border-r border-casino-gold-500/10 transform transition-transform duration-200 lg:translate-x-0 lg:static",
                    isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
                )}>
                    <div className="h-full flex flex-col p-4">
                        <div className="flex items-center justify-between lg:hidden mb-4">
                            <span className="text-sm font-bold text-casino-gold-500 uppercase tracking-wider">Menu</span>
                ...
                <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
                    ...
                    {/* Mobile Bottom Nav */}
                    <nav className="lg:hidden flex border-t border-casino-gold-500/20 bg-casino-dark-900 px-2 py-2 justify-around items-center shadow-[0_-4px_20px_rgba(0,0,0,0.5)]">
                            ...
                            return (
                                <Link
                                    ...
                                    className={clsx(
                                        ...
                                        isActive
                                            ? "text-casino-gold-500 bg-casino-gold-500/10 border border-casino-gold-500/20 shadow-[0_0_15px_rgba(255,204,0,0.1)]"
